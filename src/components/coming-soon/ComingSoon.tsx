...
export const ComingSoon: React.FC = () => {
  return (
    <section
      className="bg-[rgba(243,239,236,1)] flex items-center gap-[40px_94px] overflow-hidden justify-center flex-wrap px-[187px] py-[123px] max-md:px-5 max-md:py-[100px]"
      aria-labelledby="coming-soon-title"
    >
      <div className="self-stretch min-w-60 flex-1 shrink basis-[0%] my-auto max-md:max-w-full">
        <Logo
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/1d11b44df90ee0b06bf7f08ab6fed9c03ca5f4f48ec41d161e8dc6389f3b533e?placeholderIfAbsent=true"
          className="aspect-[4.65] w-64 max-w-full"
        />
