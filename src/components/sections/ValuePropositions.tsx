          ...
          <CardContent className="p-6">
            <div className="mb-4 flex justify-center">
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#F9F5F2]">
                <img 
                  src="/lovable-uploads/445428ae-d077-4000-b7de-e88d888f2fdb.png" 
                  alt="Microphone icon" 
                  className="w-6 h-6"
                />
              </div>
        ...
        <Card className="border-none bg-transparent shadow-none">
          <CardContent className="p-6">
            <div className="mb-4 flex justify-center">
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#F9F5F2]">
                <img 
                  src="/lovable-uploads/1aedc711-d076-4723-846c-f9933d4f7679.png" 
                  alt="Sunrise icon" 
                  className="w-6 h-6"
                />
              </div>
        ...
        <Card className="border-none bg-transparent shadow-none">
          <CardContent className="p-6">
            <div className="mb-4 flex justify-center">
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#F9F5F2]">
                <img 
                  src="/lovable-uploads/293d3e35-6d50-4cd3-a514-27f5f8e1d1a0.png" 
